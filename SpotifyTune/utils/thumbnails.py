...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("SpotifyTune/assets/font2.ttf", 30)
        font = ImageFont.truetype("SpotifyTune/assets/font.ttf", 30)
        title_font = ImageFont.truetype("SpotifyTune/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("SpotifyTune/assets/play_icons.png")
